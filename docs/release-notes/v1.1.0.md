...
在 [v1.0.0](v1.0.0.md) 基础上的功能增量版。核心交付物仍是终端编码智能体 **`springai-code-tui`**，本版新增**清空上下文、跨会话长期记忆、AGENTS.md 项目指令**三大能力，并修复了辅助模型调用不跟随 `/model` 切换等问题。
...
> 完整的功能全景与⚠️安全声明见 [v1.0.0 发布说明](v1.0.0.md)；本文只列出相对 v1.0.0 的变化。
